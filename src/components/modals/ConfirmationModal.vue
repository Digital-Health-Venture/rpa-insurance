  ...
  <v-dialog v-model="isVisible" max-width="433px" max-height="254px" persistent>
    <v-card rounded="xl">
      <div class="flex flex-col justify-center items-center">
        ...
        <v-card-text
          ><div
            class="text-center text-black font-prompt text-[16px] font-normal leading-normal max-w-[228px] text-wrap"
          >
            {{ description }}
          </div></v-card-text
        >
        <v-card-actions
          class="flex flex-col-reverse sm:flex-row justify-center px-4 py-4 mb-[14px]"
        >
          <v-btn
            variant="flat"
            color="#BFBFBF"
